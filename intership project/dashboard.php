  ...
  <div class="app-container">
    ...
    <aside class="sidebar" id="app-sidebar" aria-label="Sidebar Navigation">
      ...
      <nav class="sidebar-nav">
        ...
        <?php if ($role === 'student' || $role === 'company'): ?>
        ...
        <div class="nav-item" data-target="styleguide" role="link" aria-label="Style Guide">
          <div class="nav-item-left">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z"/><path d="M12 16V12"/><path d="M12 8H12.01"/></svg>
            <span class="nav-label">Style Guide</span>
          </div>
        </div>
      </nav>
    ...
    <main class="main-panel">
        ...
        <div class="header-right">
          ...
          <div class="profile-avatar-trigger" id="avatar-menu-trigger">
            ...
            <div class="dropdown-menu" id="avatar-menu">
              ...
              <div class="dropdown-item" onclick="switchView('styleguide')">
              ...
              <div class="dropdown-item danger">
                <a href="auth/logout.php" style="display:flex; align-items:center; gap:8px;">
      ...
      <div class="content-area">
          ...
          <div class="grid-12">
            ...
            <div class="col-8 col-lg-12">
              <div class="card">
                ...
                <form id="form-update-profile" onsubmit="event.preventDefault(); showToast('Profile Saved', 'Personal record updated in database.', 'success')">
                  <div class="grid-12">
                    <div class="col-6 col-md-12 form-group">
                      <label class="form-label">Full Name</label>
                      <input type="text" class="input-field" value="<?php echo $userName; ?>">
                    </div>
                    <div class="col-6 col-md-12 form-group">
                    ...
                    <div class="col-12 form-group">
                      ...
                      <input type="text" class="input-field" value="<?php echo $profile['skills'] ?? ''; ?>">
                    </div>
                    <div class="col-12 form-group">
                      <label class="form-label">Projects</label>
                      <textarea class="input-field" rows="3"><?php echo $profile['projects'] ?? ''; ?></textarea>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="col-6 col-md-12 form-group">
                      ...
                      <input type="url" class="input-field" value="<?php echo $profile['website'] ?? ''; ?>">
                    </div>
                    <div class="col-6 col-md-12 form-group">
                      <label class="form-label">Office Phone</label>
                      <input type="text" class="input-field" value="<?php echo $profile['phone'] ?? ''; ?>">
                    </div>
                    <?php endif; ?>
              ...
              <div class="card" style="height: 100%;">
                ...
                <div class="form-group">
                  ...
                  <select class="input-field select-custom">
                    <option>Follow System Default</option>
                    <option>Force Light Theme Only</option>
                    <option>Force Dark Theme Only</option>
                  </select>
                </div>
                <div class="form-group">
        ...
        <!-- ==================== STYLE GUIDE VIEW ==================== -->
        <div class="page-view" id="styleguide">
          <div class="card" style="margin-bottom: var(--space-3);">
            <h3 class="chart-container-title" style="margin-bottom: var(--space-05);">Design System Components (Style Guide)</h3>
            <p style="color: var(--text-secondary); font-size: 13px;">A complete overview of the typography, UI components, states and patterns built for this dashboard.</p>
          </div>

          <div class="grid-12">
            <div class="col-6 col-lg-12">
              <div class="card" style="height: 100%;">
                <h4 style="font-weight: 700; margin-bottom: var(--space-2);">Typography & Spacing</h4>
                <div style="display: flex; flex-direction: column; gap: var(--space-2);">
                  <div>
                    <h1 style="font-family: 'Inter'; font-weight: 700; font-size: 24px; color: var(--text-primary);">Inter Bold (H1 - 24px)</h1>
                  </div>
                  <div>
                    <h2 style="font-family: 'Inter'; font-weight: 600; font-size: 18px; color: var(--text-primary);">Inter SemiBold (H2 - 18px)</h2>
                  </div>
                  <div>
                    <p style="font-family: 'Inter'; font-weight: 400; font-size: 14px; color: var(--text-secondary);">Inter Regular (Body - 14px)</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-6 col-lg-12">
              <div class="card" style="height: 100%;">
                <h4 style="font-weight: 700; margin-bottom: var(--space-2);">Action Buttons</h4>
                <div style="display: flex; gap: var(--space-1); flex-wrap: wrap; align-items: center;">
                  <button class="btn btn-primary">Primary CTA</button>
                  <button class="btn btn-secondary">Secondary Link</button>
                  <button class="btn btn-ghost">Ghost Option</button>
        ...
        <form id="form-add-student-api">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="tel" class="input-field" name="phone" placeholder="+91 99999 88888">
            </div>
          </div>
          <div class="modal-footer">
      ...
      <div class="modal-content">
        ...
        <form id="form-add-company-api">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label class="form-label">Contact Phone</label>
              <input type="text" class="input-field" name="phone" placeholder="+91 22 1234 5678">
            </div>
            <div class="form-group">
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      if (restoreForm) {
        restoreForm.addEventListener("submit", (e) => {
          e.preventDefault();
          if (!confirm("Caution: This will restore database tables structure. Existing user listings will be overwritten! Continue?")) return;
        ...
        addStuForm.addEventListener("submit", (e) => {
          ...
          .then(res => {
            if (res.status === 'success') {
              ...
              showToast("Enrollment Error", res.message, "danger");
              btn.disabled = false;
            }
          });
        });
        ...
        addCompForm.addEventListener("submit", (e) => {
          ...
          .then(res => {
            if (res.status === 'success') {
              ...
              showToast("Registration Error", res.message, "danger");
              btn.disabled = false;
            }
          });
        });
