...
function sendOtpEmail($toEmail, $toName, $otp) {
  $subject = "Verify Your Email - Campus Recruitment";
  $htmlBody = "
    <!DOCTYPE html>
    <html>
    <head>
      ...
      <style>
        ...
        .otp-box { text-align: center; margin: 30px 0; background: rgba(59, 130, 246, 0.1); border: 1px solid rgba(59, 130, 246, 0.3); padding: 15px; border-radius: 8px; font-size: 32px; font-weight: bold; letter-spacing: 5px; color: #60A5FA; }
    ...
    <body>
      <div class='container'>
        ...
        <div class='content'>
          ...
          <p>Thank you for registering on the Campus Recruitment Management System. To complete your registration and verify your email address, please use the following one-time passcode (OTP):</p>
          <div class='otp-box'>{$otp}</div>
          <p>This code is valid for <strong>10 minutes</strong>. For security reasons, please do not share this OTP with anyone.</p>
  ...
  ";
  return sendSystemEmail($toEmail, $toName, $subject, $htmlBody);
}
?>
