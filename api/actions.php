...
try {
  switch ($action) {
    ...
    case 'update_user_status':
      ...
      if ($newStatus === 'approved') {
        createUserNotification(
          ...
          "Your profile registration has been approved. Welcome to Campus Recruitment!",
          "registration_status",
          "high"
        );
    ...
    case 'update_settings':
      ...
      logActivity("Updated system preferences (language: $language)", "success");
