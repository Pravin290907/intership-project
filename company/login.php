    ...
    <div class="auth-card">
      ...
      <div class="auth-back-container" style="display: flex; flex-direction: column; align-items: center; gap: 10px;">
        ...
        <div style="display: flex; justify-content: center; gap: 8px; flex-wrap: wrap;">
          ...
          <a href="login.php" class="role-badge-link active" style="font-size: 11px; font-weight: 600; padding: 6px 14px; border-radius: 20px; background: #2563EB; color: #FFF; cursor: pointer; text-decoration: none; transition: all 0.2s;">Recruiter</a>
    ...
    form.addEventListener("submit", (e) => {
      ...
      .then(res => {
        if (res.status === 'success') {
          ...
          if (res.unverified) {
            setTimeout(() => {
              window.location.href = '../auth/verify_otp.php?email=' + encodeURIComponent(res.email);
            }, 2000);
          }
        }
      })
