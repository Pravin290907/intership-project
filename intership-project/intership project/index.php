...
if (isset($_SESSION['user_id'])) {
  ...
  if ($role === 'student') $redirectPath = 'student/dashboard.php';
  else if ($role === 'company') $redirectPath = 'company/dashboard.php';
  else if ($role === 'tpo') $redirectPath = 'tpo/dashboard.php';
  else if ($role === 'admin') $redirectPath = 'admin/dashboard.php';
