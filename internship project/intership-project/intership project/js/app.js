...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function initTheme() {
    ...
    toggleBtn.addEventListener("click", () => {
      const activeThemeNow = document.documentElement.getAttribute("data-theme");
      const nextTheme = activeThemeNow === "dark" ? "light" : "dark";
    ...
    if (themeSelect) {
      ...
      themeSelect.addEventListener("change", () => {
        ...
        showToast("Theme Updated", `Theme switched to ${newTheme === 'dark' ? 'Dark Mode' : 'Light Mode'}.`, "info");
