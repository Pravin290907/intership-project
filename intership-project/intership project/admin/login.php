      ...
      <form id="admin-login-form" novalidate>
        ...
        <div class="form-group" style="margin-bottom: var(--space-25);">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <span style="font-size:12px;"><a href="#" onclick="Swal.fire({title: 'Forgot Password?', text: 'Please contact the IT Cell administrators to reset server passwords.', icon: 'info', confirmButtonColor: '#2563EB'})" style="color:#60A5FA;">Forgot?</a></span>
          </div>
          <div class="input-icon-wrapper">
